...
})(SPANState || (exports.SPANState = SPANState = {}));
var MPANState;
(function (MPANState) {
    /** No entry exists */
...
})(MPANState || (exports.MPANState = MPANState = {}));
...
class SecurityManager2 {
    ...
    getNextMulticastGroupId = (0, shared_1.createWrappingCounter)(255);
    ...
    getMulticastKeyAndIV(groupId) {
        ...
        const ret = (0, crypto_1.encryptAES128ECB)(stateN, keys.keyMPAN).subarray(0, 13);
