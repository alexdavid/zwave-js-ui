...
function generateAuthKey(networkKey) {
    return (0, crypto_1.encryptAES128ECB)(authKeyBase, networkKey);
}
exports.generateAuthKey = generateAuthKey;
function generateEncryptionKey(networkKey) {
    return (0, crypto_1.encryptAES128ECB)(encryptionKeyBase, networkKey);
}
...
class SecurityManager {
    ...
    generateNonce(receiver, length) {
        ...
        let nonceId;
        do {
            nonce = (0, node_crypto_1.randomBytes)(length);
