...
exports.isMissingControllerCallback = exports.isMissingControllerResponse = exports.isMissingControllerACK = exports.isRecoverableZWaveError = exports.isTransmissionError = exports.isZWaveError = exports.ZWaveError = exports.getErrorSuffix = exports.ZWaveErrorCodes = void 0;
...
(function (ZWaveErrorCodes) {
    ...
    ZWaveErrorCodes[ZWaveErrorCodes["Controller_InclusionFailed"] = 206] = "Controller_InclusionFailed";
    ZWaveErrorCodes[ZWaveErrorCodes["Controller_ExclusionFailed"] = 207] = "Controller_ExclusionFailed";
    /** Tried to do something the controller does not support */
    ZWaveErrorCodes[ZWaveErrorCodes["Controller_NotSupported"] = 208] = "Controller_NotSupported";
    /** The interview for this node was restarted by the user */
    ZWaveErrorCodes[ZWaveErrorCodes["Controller_InterviewRestarted"] = 209] = "Controller_InterviewRestarted";
    /** The node with the given node ID was not found */
    ZWaveErrorCodes[ZWaveErrorCodes["Controller_NodeNotFound"] = 210] = "Controller_NodeNotFound";
    /** The endpoint with the given index was not found on the node */
    ZWaveErrorCodes[ZWaveErrorCodes["Controller_EndpointNotFound"] = 211] = "Controller_EndpointNotFound";
    /** The node was removed from the network */
    ZWaveErrorCodes[ZWaveErrorCodes["Controller_NodeRemoved"] = 212] = "Controller_NodeRemoved";
    /** Communication with the node will be insecure (no security configured) */
    ZWaveErrorCodes[ZWaveErrorCodes["Controller_NodeInsecureCommunication"] = 213] = "Controller_NodeInsecureCommunication";
    /** The message has expired (the given timeout has elapsed) */
    ZWaveErrorCodes[ZWaveErrorCodes["Controller_MessageExpired"] = 214] = "Controller_MessageExpired";
    /** A Serial API command resulted in an error response */
    ZWaveErrorCodes[ZWaveErrorCodes["Controller_CommandError"] = 215] = "Controller_CommandError";
    /** Tried to send a message that is too large */
    ZWaveErrorCodes[ZWaveErrorCodes["Controller_MessageTooLarge"] = 216] = "Controller_MessageTooLarge";
...
})(ZWaveErrorCodes || (exports.ZWaveErrorCodes = ZWaveErrorCodes = {}));
...
exports.isMissingControllerACK = isMissingControllerACK;
function isMissingControllerResponse(e) {
    return isZWaveError(e)
        && e.code === ZWaveErrorCodes.Controller_Timeout
        && e.context === "response";
}
exports.isMissingControllerResponse = isMissingControllerResponse;
function isMissingControllerCallback(e) {
    return isZWaveError(e)
        && e.code === ZWaveErrorCodes.Controller_Timeout
        && e.context === "callback";
}
exports.isMissingControllerCallback = isMissingControllerCallback;
