...
export declare function parseNodeUpdatePayload(nif: Buffer, nodeIdType?: NodeIDType): NodeUpdatePayload;
export declare function encodeNodeUpdatePayload(nif: NodeUpdatePayload, nodeIdType?: NodeIDType): Buffer;
...
export declare function parseNodeID(buffer: Buffer, type?: NodeIDType, offset?: number): {
    nodeId: number;
    bytesRead: number;
};
export declare function encodeNodeID(nodeId: number, type?: NodeIDType): Buffer;
