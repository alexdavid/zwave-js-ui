...
export declare class VersionCCAPI extends PhysicalCCAPI {
    ...
    reportCCVersion(requestedCC: CommandClasses): Promise<void>;
...
export declare class VersionCCReport extends VersionCC {
    constructor(host: ZWaveHost, options: CommandClassDeserializationOptions | (VersionCCReportOptions & CCCommandOptions));
