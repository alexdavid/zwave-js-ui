import { DateAndTime, FirmwareUpdateCapabilities, LifelineHealthCheckSummary, RouteHealthCheckSummary, TranslatedValueID, ValueMetadata } from "zwave-js";
import { MaybeNotKnown, SecurityClass, SupervisionResult } from "@zwave-js/core";
...
export interface NodeResultTypes {
    ...
    [NodeCommand.getDefinedValueIDs]: {
    ...
    [NodeCommand.setRawConfigParameterValue]: {
    ...
    [NodeCommand.hasSecurityClass]: {
        hasSecurityClass: MaybeNotKnown<boolean>;
    };
    [NodeCommand.getHighestSecurityClass]: {
        highestSecurityClass: MaybeNotKnown<SecurityClass>;
    };
    [NodeCommand.testPowerlevel]: {
        framesAcked: number;
    };
    [NodeCommand.checkLifelineHealth]: {
        summary: LifelineHealthCheckSummary;
    };
    [NodeCommand.checkRouteHealth]: {
        summary: RouteHealthCheckSummary;
    };
    [NodeCommand.getValue]: {
        value?: any;
    };
    [NodeCommand.getEndpointCount]: {
        count: number;
    };
    [NodeCommand.interviewCC]: Record<string, never>;
    [NodeCommand.getState]: {
        state: NodeState;
    };
    ...
    [NodeCommand.setDateAndTime]: {
        success: boolean;
    };
    [NodeCommand.getDateAndTime]: {
        dateAndTime: DateAndTime;
    };
    [NodeCommand.isHealthCheckInProgress]: {
        progress: boolean;
    };
    ...
    [NodeCommand.hasDeviceConfigChanged]: {
        changed: MaybeNotKnown<boolean>;
    };
}
