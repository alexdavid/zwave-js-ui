import { AssociationAddress, AssociationGroup, FirmwareUpdateInfo, LifelineRoutes, RFRegion, SmartStartProvisioningEntry } from "zwave-js";
...
export interface ControllerResultTypes {
    [ControllerCommand.beginInclusion]: {
        success: boolean;
    };
    [ControllerCommand.stopInclusion]: {
        success: boolean;
    };
    [ControllerCommand.beginExclusion]: {
        success: boolean;
    };
    [ControllerCommand.stopExclusion]: {
        success: boolean;
    };
    ...
    [ControllerCommand.healNode]: {
        success: boolean;
    };
    [ControllerCommand.rebuildNodeRoutes]: {
        success: boolean;
    };
    [ControllerCommand.beginHealingNetwork]: {
        success: boolean;
    };
    [ControllerCommand.beginRebuildingRoutes]: {
        success: boolean;
    };
    [ControllerCommand.stopHealingNetwork]: {
        success: boolean;
    };
    [ControllerCommand.stopRebuildingRoutes]: {
        success: boolean;
    };
    [ControllerCommand.isFailedNode]: {
        failed: boolean;
    };
    ...
    [ControllerCommand.isAssociationAllowed]: {
        allowed: boolean;
    };
    ...
    [ControllerCommand.getNodeNeighbors]: {
    ...
    [ControllerCommand.supportsFeature]: {
        supported: boolean | undefined;
    };
    [ControllerCommand.backupNVMRaw]: {
        nvmData: string;
    };
    [ControllerCommand.restoreNVM]: Record<string, never>;
    [ControllerCommand.setRFRegion]: {
        success: boolean;
    };
    [ControllerCommand.getRFRegion]: {
        region: RFRegion;
    };
    [ControllerCommand.setPowerlevel]: {
        success: boolean;
    };
    ...
    [ControllerCommand.isFirmwareUpdateInProgress]: {
        progress: boolean;
    };
}
